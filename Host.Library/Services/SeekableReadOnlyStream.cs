...
namespace Host.Library.Adapters
{
    public class SeekableReadOnlyStream : Stream
    {
        ...
        /// </summary>
        /// <param name="baseStream">Base stream</param>
        public SeekableReadOnlyStream(Stream baseStream)
            : this(baseStream, new VirtualStream())
        {
            // Empty
        }
        ...
        public SeekableReadOnlyStream(Stream baseStream, int bufferSize)
            : this(baseStream, new VirtualStream(bufferSize))
        {
            // Empty
        }
        ...
        private int _readTimout = int.MaxValue;
