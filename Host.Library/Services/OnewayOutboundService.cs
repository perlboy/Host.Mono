...
{
    public abstract class OnewayOutboundService : OutboundService, IOnewayOutboundService
    {
...
var route = true;"
            ...
            actionConfig.config.staticConfig.Remove(actionConfig.config.staticConfig.FirstOrDefault(c => c.id == "outboundScript"));
